...
import 'package:adminpanel_new/screen/rescue_tasks/rescue_tasks_screen.dart';
...
class _MainLayoutState extends State<MainLayout> {
  ...
  static const List<_PageMeta> _pages = [
    _PageMeta(
      'Dashboard Overview',
      'AI-driven situational awareness for active operations',
    ),

    _PageMeta(
      'Disaster Monitoring',
      'Continuous AI surveillance of disaster signals',
    ),

    _PageMeta(
      'Live Map',
      'Geo-spatial view of all active operations',
    ),

    _PageMeta(
      'User Reports',
      'Citizen-submitted incident reports queue',
    ),

    _PageMeta(
      'Rescue Teams',
      'Deployment status across all field units',
    ),
    ...
    _PageMeta(
      'Citizens',
      'Registered citizens management',
    ),

    _PageMeta(
      'Affected Zones',
      'Mapped polygons of impacted regions',
    ),
    ...
    _PageMeta(
      ...
      'Outbound public & internal alert log',
    ),

    _PageMeta(
      'Shelters & Resources',
      'Capacity and supply tracking',
    ),
    ...
    _PageMeta(
      'Settings',
      'System, user and integration configuration',
    ),
  ];
