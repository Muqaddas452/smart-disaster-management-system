                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => Scaffold(
                          ...
                          body: DisasterMap(
                            // Agar alert ke sath koi lat/lng ya area save hai, woh yahan pass karein
                            // Misal ke taur par agar Firestore alert document mein lat/lng hain:
                            targetLat: alert.lat,
                            targetLng: alert.lng,
                            targetTitle: alert.district.isNotEmpty ? alert.district : 'Emergency Location',
                          ),
                        ),
                      ),
                    );
