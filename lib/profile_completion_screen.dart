  ...
  Future<void> _saveProfileToFirestore() async {
    ...
    try {
      ...
      if (!serviceEnabled) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Location services are disabled. Please turn on GPS.'), backgroundColor: Colors.red),
          );
        }
        return;
      }
      ...
      // 3.get current latitude nad longitude
      ...
      // save latitude and longitude with profile data in firestore
      ...
      // 5. Ensure FCM Token is saved & listening on Profile Completion
