  ...
  void _onSignUpPressed() async {
    ...
    if (isSuccess) {
      ...
      if (currentUser != null) {
        ...
        // signout user from firebase after signup so that user cannot enter without verification
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Your account has been created. Please check your email and verify your account'),
